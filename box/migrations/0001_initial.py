# Generated by Django 3.0.4 on 2020-03-15 20:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='box.topic')),
            ],
        ),
        migrations.CreateModel(
            name='Hotel',
            fields=[
                ...
                ('person_id', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
